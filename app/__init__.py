...
from app.routes import main_routes_bp, fabrics_bp, discount_groups_bp, lead_times_bp, excel_tools_bp, customer_automation_bp, max_discount_review_bp, user_management_bp
